...
from dataloaders.dataset import (BaseDataSets, RandomGenerator,
                                 TwoStreamBatchSampler, BaseDataSets_Synapse)
...
def train(args, snapshot_path):
    ...
    db_train = BaseDataSets_Synapse(base_dir=args.root_path, split="train", num=None, transform=transforms.Compose([
